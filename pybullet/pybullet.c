...
static PyObject* pybullet_setCameraViewPoint(PyObject* self, PyObject* args, PyObject *keywds) {
	...
	static char *kwlist[] = { "targetPosX", "targetPosY", "targetPosZ", "pitch", "yaw", "dist", "physicsClientId", NULL };
	b3PhysicsClientHandle sm = 0;

	if (!PyArg_ParseTupleAndKeywords(args, keywds, "dddddd|i", kwlist, &targetPosX, &targetPosY, &targetPosZ,
		&pitch, &yaw, &dist, &physicsClientId))
		return NULL;
	...
	commandHandle = b3ResetCameraTargetPosition(sm, targetPosX, targetPosY, targetPosZ, pitch, yaw, dist);
...
static PyMethodDef SpamMethods[] = {
	...
	{ "setCameraViewPoint", (PyCFunction)pybullet_setCameraViewPoint, METH_VARARGS | METH_KEYWORDS,
	"Set the target view point of camera to provide different view angles." },
